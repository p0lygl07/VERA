...
def run_headless_selenium(script_logic_fn):
    ...
    # Target sandbox directory structure
    workspace = "/home/joshua/vera/data/sandbox_workspace"
    options.add_argument(f"--user-data-dir={os.path.join(workspace, 'chrome_profile')}")
...
if __name__ == "__main__":
    ...
    print(json.dumps(run_headless_selenium(test_logic)))