...
## Recording findings
- Use run_skill(name="bug-bounty-recon", kwargs={"target": "...", "findings": "..."}) to log a recon note or finding to the shared execution log (recon_core.log_event) -- this was previously dead code with no way to call it, since this SKILL.md had no entry_point.
